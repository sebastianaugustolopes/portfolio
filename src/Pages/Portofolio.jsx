...
const techStacks = [
  ...
  { icon: "react-native.svg", language: "ReactJS" },
  { icon: "vue-js.svg", language: "Vue.js" },
  { icon: "vite.svg", language: "Vite" },
  { icon: "typescript.svg", language: "Typescript" },
  { icon: "nodejs.svg", language: "Node JS" },
  { icon: "postgresql.svg", language: "PostgresSQL" },
  { icon: "supabase.svg", language: "Supabase" },
  { icon: "drizzleteam.svg", language: "Drizzle" },
...
export default function FullWidthTabs() {
  ...
  // Remaining component (return statement) has no changes
  return (
    <div
    ...
    >
      ...
      >
        ...
        <p className="text-slate-400 max-w-2xl mx-auto text-sm md:text-base mt-2">
          Explore minha jornada por projetos, certificações e experiências
          técnicas.
        </p>
      </div>
