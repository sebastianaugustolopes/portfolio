  ...
  <div className="flex justify-end items-center sm:p-12 sm:py-0 sm:pb-0 p-0 py-2 pb-2">
    <div className="relative group" data-aos="fade-up" data-aos-duration="1000">
      ...
      <div className="relative">
        <div className="w-72 h-72 sm:w-80 sm:h-80 rounded-3xl overflow-hidden shadow-[0_0_40px_rgba(120,119,198,0.3)] transform transition-all duration-700 group-hover:scale-105">
          <div className="absolute inset-0 border-4 border-white/20 rounded-3xl z-20 transition-all duration-700 group-hover:border-white/40 group-hover:scale-105" />
    ...
    () => [
      {
        ...
        value: totalProjects,
        label: "Projetos expostos",
        description: "Projetos que ilustram o processo de desenvolvimento",
      ...
      },
      {
        ...
        label: "Certificados",
        description: "Validação de habilidades profissionais",
        animation: "fade-up",
      },
      {
        icon: Globe,
      ...
      <div className="w-full mx-auto pt-8 sm:pt-12 relative">
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <div
              className="max-w-4xl space-y-4 text-base sm:text-lg lg:text-xl text-gray-400 leading-relaxed pb-4 sm:pb-0"
              data-aos="fade-right"
              data-aos-duration="1500"
            >
              ...
              <p className="text-start">
                ...
                ferramentas como{" "}
                <span className="text-[#6366f1] font-medium">React</span>,{" "}
                <span className="text-[#6366f1] font-medium">Vue</span>,{" "}
                <span className="text-[#6366f1] font-medium">Tailwind</span>,{" "}
                <span className="text-[#6366f1] font-medium">TypeScript</span>,
                entre outras tecnologias do ecossistema JavaScript.
              </p>
              ...
              {showFullText && (
                <>
                  ...
                  <p className="text-start">
                    ...
                    evolução, buscando sempre me aproximar do nível profissional
                    e construir projetos que reflitam meu aprendizado.
                  </p>
                </>
              )}
              ...
              <button
                ...
                className="flex items-center gap-2 text-[#6366f1] hover:text-[#a855f7] transition-colors duration-300 font-medium text-sm sm:text-base"
              >
                {showFullText ? (
                  <>
            ...
            >
              ...
              <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
                Conhecimento sem criatividade é como um livro fechado.
              </blockquote>
            </div>
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              ...
              <a href="#Portofolio" className="w-full lg:w-auto">
                ...
                >
                  <Code className="w-4 h-4 sm:w-5 sm:h-5" /> Projetos
                </button>
              </a>
            </div>
          </div>
